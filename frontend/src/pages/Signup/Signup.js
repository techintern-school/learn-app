...
class SignupPage extends React.Component {
  ...
  render() {
    return (
      <div>
        <Header brand="techIntern.school" fixed color="primary" />
        <GridContainer justify="center" alignItems="center">
          <GridItem xs={10} sm={10} md={12}>
            <h2 style={{ paddingTop: 70, textAlign: "center" }}>
              Thanks for your interest in enrolling in techIntern.school
            </h2>
          </GridItem>
          ...
          <form
            action="https://school.us19.list-manage.com/subscribe/post"
            method="POST"
            noValidate
          >
            ...
            >
              <input
                type="text"
                name="b_1489a6b87612b4e8ed744e47e_c0f77afcb9"
                tabIndex="-1"
                defaultValue=""
              />
            </div>
