    ...
    fs.writeFileSync(
      ...
      JSON.stringify(
        Object.assign({}, config, {
          currentCurriculumVersion: newCurriculumVersion,
        }),
        null,
        4
      )
...
program
  ...
  .action((name) => {
    ...
    fs.readdir(projectsDirectory, (err, files) => {
      ...
      const macrosReplacedTemplate = processMacros(template, {
        name,
